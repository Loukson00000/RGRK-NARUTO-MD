...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ; NARUTO MD bot;https://iili.io/dmKqfTP.jpg' : process.env.AUDIO_DATA,
